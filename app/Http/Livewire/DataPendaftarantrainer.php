...
class DataPendaftarantrainer extends Component
{
    ...
    {
        return view('livewire.trainer.data-pendaftarantrainer',[
            'daftarkelas' => DaftarDataKelas::where('id', auth()->user()->id)->get(),
